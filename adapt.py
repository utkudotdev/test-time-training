...
def gradient_adapt(
    ...
    for _ in range(n_steps):
        ...
        prox_loss = sum(
            (p - a).pow(2).sum()
            for p, a in zip(enc_params, anchor)
        )
...
def main():
    ...
    print(f"         grad_steps_full={GRAD_STEPS_FULL}  fast={GRAD_STEPS_FAST}  lr={GRAD_LR}  prox_lambda={PROX_LAMBDA}")
    ...
    for cond in TEST_CONDITIONS:
        ...
        print(f"{label:<22}  {zs_r:>10.1f}  {fast_r:>10.1f}  {ada_r:>10.1f}  {steps:>6}")
